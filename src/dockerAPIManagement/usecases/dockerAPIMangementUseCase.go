...
func (u *UseCase) StartContainer(ctx context.Context, containerID string, options container.StartOptions) error {
	if err := u.DockerService.StartContainer(ctx, containerID, options); err != nil {
...
func (u *UseCase) StopContainer(ctx context.Context, containerID string, timeout *int) error {
	if err := u.DockerService.StopContainer(ctx, containerID, timeout); err != nil {
...
func (u *UseCase) RemoveContainer(ctx context.Context, containerID string, options container.RemoveOptions) error {
	if err := u.DockerService.RemoveContainer(ctx, containerID, options); err != nil {
...
func (u *UseCase) GetImages(ctx context.Context, options image.ListOptions) ([]image.Summary, error) {
	images, err := u.DockerService.ListImages(ctx, options)
	if err != nil {
		log.Printf("Usecase Error GetImages: %v", err)
...
func (u *UseCase) ExecContainerCreate(ctx context.Context, containerID string, config container.ExecOptions) (types.IDResponse, error) {
	...
	if err != nil {
		...
		return types.IDResponse{}, fmt.Errorf("failed to create exec instance: %w", err)
	}
	return response, nil
}
...
func (u *UseCase) ContainerLogs(ctx context.Context, containerID string, options container.LogsOptions) (io.ReadCloser, error) {
	logs, err := u.DockerService.ContainerLogs(ctx, containerID, options)
	if err != nil {
...
func (u *UseCase) RemoveNetwork(ctx context.Context, networkID string) error {
	if err := u.DockerService.RemoveNetwork(ctx, networkID); err != nil {
...
func (u *UseCase) RemoveVolume(ctx context.Context, volumeID string) error {
	if err := u.DockerService.RemoveVolume(ctx, volumeID); err != nil {
